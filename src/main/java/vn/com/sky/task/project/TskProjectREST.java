                                ...
                                .flatMap(
                                    errs -> {
                                        if (errs.size() > 0) {
                                            ...
                                            return saveEntity(mainRepo, projectReq, getUserId(request)).flatMap(e -> {
                                ...
                                .flatMap(
                                    errs -> {
                                        if (errs.size() > 0) {
                                            ...
                                            return updateEntity(mainRepo, projectReq, getUserId(request)).flatMap(e -> ok(e, TskProject.class));
                                        }
                                    }
                                );
                        }
